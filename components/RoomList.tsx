    ...
    return (
        <div>
            <div className="mb-2">
                ...
                {user?.role === "ADMIN" && Project.adminOnlyRooms.map((name)=>(<RoomName usersPerRoom={usersPerRoom} currentRoom={room} key={name} name={name} icon={<HashtagIcon/>} onChange={setRoom}/>))}
            </div>
            <div className="mb-2">
                <label className="sidebar-label">
                    Voice
                ...
                {user?.role === "ADMIN" && Project.adminVoiceOnlyRooms.map((name)=>(<RoomName usersPerRoom={usersPerRoom} voice currentRoom={room} key={name} name={name} icon={<MicIcon/>} onChange={setRoom}/>))}
            </div>
            <div className="mb-2">
            <label className="sidebar-label">
                Personal
